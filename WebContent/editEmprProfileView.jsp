		...
		<div class="col-lg-10 col-md-10 col-sm-12 bg-light">
					<h2>Edit Profile</h2>
						...
						<table class="table">
							...
							<tr>
								<td>Address</td>
								<td><input type="text" class="form-control-sm" value="empr_address"></td>
							</tr>
							<tr>
								<td>Mobile Number</td>
								<td><input type="text" class="form-control-sm" value="empr_mobile"></td>
							</tr>
							<tr>
								<td>Email Address</td>
								<td><input type="email" class="form-control-sm" value="empr_email_address"></td>
							</tr>
							<tr>
								<td>Old Password</td>
								<td><input type="password" class="form-control-sm" value=""></td>
							</tr>
							<tr>
								<td>New Password</td>
								<td><input type="password" class="form-control-sm" value=""></td>
